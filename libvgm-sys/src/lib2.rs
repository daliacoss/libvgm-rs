...
pub const FCC_EMU_: u32 = 1162695936;
...
pub const FCC_NRS_: u32 = 1314018048;
pub const FCC_VBEL: u32 = 1447183692;
pub const FCC_CTR_: u32 = 1129599488;
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _waveform_32bit_stereo {
    pub L: DEV_SMPL,
    pub R: DEV_SMPL,
}
#[test]
fn bindgen_test_layout__waveform_32bit_stereo() {
    assert_eq!(
        ::std::mem::size_of::<_waveform_32bit_stereo>(),
        8usize,
        concat!("Size of: ", stringify!(_waveform_32bit_stereo))
    );
    assert_eq!(
        ::std::mem::align_of::<_waveform_32bit_stereo>(),
        4usize,
        concat!("Alignment of ", stringify!(_waveform_32bit_stereo))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_waveform_32bit_stereo>())).L as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(_waveform_32bit_stereo),
            "::",
            stringify!(L)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_waveform_32bit_stereo>())).R as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(_waveform_32bit_stereo),
...
pub type WAVE_32BS = _waveform_32bit_stereo;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _resampling_state {
...
#[test]
fn bindgen_test_layout__resampling_state() {
    assert_eq!(
        ::std::mem::size_of::<_resampling_state>(),
        80usize,
        concat!("Size of: ", stringify!(_resampling_state))
    );
    assert_eq!(
        ::std::mem::align_of::<_resampling_state>(),
        8usize,
        concat!("Alignment of ", stringify!(_resampling_state))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_resampling_state>())).smpRateSrc as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(_resampling_state),
            "::",
            stringify!(smpRateSrc)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_resampling_state>())).smpRateDst as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(_resampling_state),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_resampling_state>())).volumeL as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(_resampling_state),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_resampling_state>())).volumeR as *const _ as usize },
        10usize,
        concat!(
            "Offset of field: ",
            stringify!(_resampling_state),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_resampling_state>())).resampleMode as *const _ as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(_resampling_state),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_resampling_state>())).resampler as *const _ as usize },
        13usize,
        concat!(
            "Offset of field: ",
            stringify!(_resampling_state),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_resampling_state>())).StreamUpdate as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(_resampling_state),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_resampling_state>())).su_DataPtr as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(_resampling_state),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_resampling_state>())).smpP as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(_resampling_state),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_resampling_state>())).smpLast as *const _ as usize },
        36usize,
        concat!(
            "Offset of field: ",
            stringify!(_resampling_state),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_resampling_state>())).smpNext as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(_resampling_state),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_resampling_state>())).lSmpl as *const _ as usize },
        44usize,
        concat!(
            "Offset of field: ",
            stringify!(_resampling_state),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_resampling_state>())).nSmpl as *const _ as usize },
        52usize,
        concat!(
            "Offset of field: ",
            stringify!(_resampling_state),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_resampling_state>())).smplBufSize as *const _ as usize },
        60usize,
        concat!(
            "Offset of field: ",
            stringify!(_resampling_state),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<_resampling_state>())).smplBufs as *const _ as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(_resampling_state),
...
pub type RESMPL_STATE = _resampling_state;
extern "C" {
